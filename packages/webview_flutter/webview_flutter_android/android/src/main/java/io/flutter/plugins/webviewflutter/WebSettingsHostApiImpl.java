...
public class WebSettingsHostApiImpl implements WebSettingsHostApi {
  ...
  // Android: Deprecated in API 30; retained for compatibility with file:// content.
  // Ref: https://developer.android.com/reference/android/webkit/WebSettings#setAllowUniversalAccessFromFileURLs(boolean)
  ...
  // Android: Deprecated in API 30; retained for compatibility with file:// content.
  // Ref: https://developer.android.com/reference/android/webkit/WebSettings#setAllowFileAccessFromFileURLs(boolean)
  @SuppressWarnings("deprecation")
  @Override
