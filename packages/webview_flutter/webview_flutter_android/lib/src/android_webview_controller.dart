...
class AndroidWebViewController extends PlatformWebViewController {
  ...
  Future<void> loadFile(
    ...
    final String url = absoluteFilePath.startsWith('file://')
        ? absoluteFilePath
        // Android file paths use non-Windows semantics regardless of the test host.
        // Ref: https://api.dart.dev/dart-core/Uri/Uri.file.html
        : Uri.file(absoluteFilePath, windows: false).toString();
  ...
  Future<void> loadFlutterAsset(
    ...
    return _webView.loadUrl(
      Uri.file('/android_asset/$assetFilePath', windows: false).toString(),
      <String, String>{},
    );
  }
  ...
  Future<void> setPlatformNavigationDelegate(
    ...
    await Future.wait(<Future<void>>[
      handler.setOnLoadUrl(_webView.loadUrl),
  ...
  Future<void> setDownloadListener(
    ...
    _webView.setDownloadListener(
        android_webview.DownloadListener(onDownloadStart: onDownloadStart));
  }
...
class AndroidNavigationDelegate extends PlatformNavigationDelegate {
  ...
  /// Sets the raw URL loader used for schemes that WebView cannot handle.
  Future<void> setOnLoadUrl(
    Future<void> Function(String, Map<String, String>) onLoadUrl,
  ) async {
    _rawLoadUrl = onLoadUrl;
  }
